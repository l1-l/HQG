...
def do_track(cfg, model):
    ...
    if cfg.track.mot20:
        gtfiles = glob.glob(os.path.join('/home/dell/MOT20/train', '*/gt/gt{}.txt'.format(gt_type)))
    else:
        gtfiles = glob.glob(os.path.join('/home/dell/MOT17/train', '*/gt/gt{}.txt'.format(gt_type)))
...
if __name__ == "__main__":
    ...
    args.num_gpus = 1
    args.config_file = 'mot17_track_cfg.py'
    launch(
        main,
        args.num_gpus,
